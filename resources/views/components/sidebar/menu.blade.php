@if (!empty($submenu) && $submenu == 'sub')
	<li class="menu-item menu-item-submenu {{ request()->is($url) ? 'menu-item-active menu-item-open' : '' }}"
...
@else
	<li class="m-item menu-item {{ request()->is($url) ? 'menu-item-active' : '' }}" aria-haspopup="{{ $popup }}"
